    ...
    public static class AssetLoader
    {
        ...
        public static AssetLoaderOptions CreateDefaultLoaderOptions(bool generateAssets = false)
        {
            ...
            var materialMappers = new List<MaterialMapper>();
                        Debug.Log("force standed materials count "+ MaterialMapper.RegisteredMappers.Count);
            for (var i = 0; i < MaterialMapper.RegisteredMappers.Count; i++)
            {
                ...
                if (materialMapperName == null)
                {
                    continue;
                        ...
                        Debug.Log("force standed materials name "+ MaterialMapper.RegisteredMappers[i]);
                ...
                try
                {
                    ...
                    if (generateAssets)
                    {
                        ...
                        Debug.Log("force standed -> 1 "+materialMapper.ForceStandardMaterial);
                        Debug.Log("force standed materials "+materialMapper.name);
                    }
                    else
                    {
                        materialMapper = CreateScriptableObjectSafe(materialMapperName, materialMapperNamespace) as MaterialMapper;
                        Debug.Log("force standed materials -> 2"+materialMapper.ForceStandardMaterial);
                    }
#else
                    materialMapper = CreateScriptableObjectSafe(materialMapperName, materialMapperNamespace) as MaterialMapper;
#endif
                ...
                {
                        Debug.Log("force standed materials -> error");
                ...
                if (materialMapper != null)
                {
                    ...
                    if (materialMapper.IsCompatible(null))
                    {
                        ...
                        Debug.Log("force select"+materialMapper.name);
                    }
                    else
                    {
#if UNITY_EDITOR
